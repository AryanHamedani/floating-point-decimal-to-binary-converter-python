def binary_converter (dec_num):
    #spliting integer part and floating point part by '.' and store them in dec_whole and dec_dec
    ...
    #store '' in binary decimal part and looping over decimal floating point untill its gone or untill we want
    bin_dec = ''
